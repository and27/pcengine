...
- [ ] PCE-001 Project domain model + persistence
- [ ] PCE-002 Project list (Active / Frozen / Archived)
- [ ] PCE-003 Project detail & edit fields
- [ ] PCE-004 Lifecycle actions: Launch / Finish / Freeze / Archive
- [ ] PCE-005 Enforce max 3 Active projects (hard rule)
